...
A simple web application for searching code across GitHub repositories using the GitHub Search API. This project is a simple exercise for learning Flask, a micro web framework written in Python. Still in development. 
